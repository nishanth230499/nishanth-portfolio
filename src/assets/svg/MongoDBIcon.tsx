  ...
  return (
    <svg
      ...
      <path
        ...
        fill='#599636'
        className='fill-current group-hover:fill-[#599636] group-focus:fill-[#599636]'
      />
      <path
        ...
        fill='#6cac48'
        className='fill-current group-hover:fill-[#6cac48] group-focus:fill-[#6cac48]'
      />
      <path
        ...
        fill='#c2bfbf'
        className='fill-current group-hover:fill-[#c2bfbf] group-focus:fill-[#c2bfbf]'
      />
    </svg>
  )
}
