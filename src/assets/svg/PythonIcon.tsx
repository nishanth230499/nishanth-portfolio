          ...
          <g>
            <g>
              <path
                ...
                // fill='#347AB4'
                className='fill-current group-hover:fill-[#347AB4] group-focus:fill-[#347AB4]'
              />
              <g>
                <path
                  ...
                  //   fill='#275C87'
                  className='fill-transparent group-hover:fill-[#275C87] group-focus:fill-[#275C87]'
                />
              </g>
            </g>
            <g>
              <path
                ...
                // fill='#FFCA1D'
                className='fill-current group-hover:fill-[#FFCA1D] group-focus:fill-[#FFCA1D]'
              />
              <g>
                <path
                  ...
                  //   fill='BF9816'
                  className='fill-transparent group-hover:fill-[#BF9816] group-focus:fill-[#BF9816]'
                />
              </g>
            </g>
            <path
              ...
              //   fill='#FFFFFF'
              className='fill-(--background) group-hover:fill-[#FFFFFF] group-focus:fill-[#FFFFFF]'
            />
            <path
